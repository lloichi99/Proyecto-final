...
nombreKdrama('doctor_stranger').
nombreKdrama('dr_romantic').
nombreKdrama('good_doctor').
nombreKdrama('hospital_playlist').
nombreKdrama('signal').
nombreKdrama('reply_1988').
nombreKdrama('reply_1997').
nombreKdrama('reply_1994').
nombreKdrama('youth_of_may').
nombreKdrama('navillera').
nombreKdrama('the_sound_of_magic').
nombreKdrama('sky_castle').
nombreKdrama('the_world_of_the_married').
nombreKdrama('arthdal_chronicles').
nombreKdrama('mouse').
nombreKdrama('taxi_driver').
nombreKdrama('law_school').
nombreKdrama('uncontrollably_fond').
nombreKdrama('the_penthouse').
nombreKdrama('romance_is_a_bonus_book').
nombreKdrama('because_this_is_my_first_life').
nombreKdrama('cheese_in_the_trap').
nombreKdrama('her_private_life').
nombreKdrama('the_undateables').
nombreKdrama('live_up_to_your_name').
nombreKdrama('forest').
nombreKdrama('oh_my_venus').
nombreKdrama('the_light_in_your_eyes').
nombreKdrama('something_in_the_rain').
nombreKdrama('search_www').
nombreKdrama('secret_garden').
nombreKdrama('protect_the_boss').
nombreKdrama('strongest_deliveryman').
nombreKdrama('the_k2').
nombreKdrama('black').
nombreKdrama('beautiful_mind').
nombreKdrama('white_christmas').
nombreKdrama('the_guest').
nombreKdrama('train_to_busan_the_series').
nombreKdrama('empress_ki').
nombreKdrama('man_to_man').
nombreKdrama('misty').
nombreKdrama('flower_of_evil').
nombreKdrama('kingdom').
nombreKdrama('love_in_the_moonlight').
nombreKdrama('cheer_up').
nombreKdrama('doctors').
nombreKdrama('prison_playbook').
nombreKdrama('strangers_from_hell').
nombreKdrama('alice').
nombreKdrama('mrs_cop').
nombreKdrama('class_of_lies').
nombreKdrama('the_last_empress').
nombreKdrama('vagabond').
nombreKdrama('life_on_mars').
nombreKdrama('shine_or_go_crazy').
nombreKdrama('the_crowned_clown').
nombreKdrama('blood').
nombreKdrama('zombie_detective').
nombreKdrama('my_secret_terrius').
nombreKdrama('kairos').
nombreKdrama('the_great_show').
nombreKdrama('angel_s_last_mission_love').
nombreKdrama('run_on').
nombreKdrama('into_the_ring').
nombreKdrama('dali_and_cocky_prince').
nombreKdrama('school_2021').
nombreKdrama('the_veil').
nombreKdrama('inspector_koo').
nombreKdrama('yumi_s_cells').
nombreKdrama('the_red_sleeve').
nombreKdrama('my_name').
nombreKdrama('hometown_cha_cha_cha').
nombreKdrama('melancholia').
nombreKdrama('happiness').
nombreKdrama('now_we_are_breaking_up').
nombreKdrama('the_law_cafe').
nombreKdrama('big_mouth').
nombreKdrama('love_in_contract').
nombreKdrama('alchemy_of_souls').
nombreKdrama('juvenile_justice').
nombreKdrama('all_of_us_are_dead').
nombreKdrama('our_beloved_summer').
nombreKdrama('a_business_proposal').
nombreKdrama('thirty_nine').
nombreKdrama('through_the_darkness').
nombreKdrama('again_my_life').
nombreKdrama('love_all_play').
nombreKdrama('clean_with_passion_for_now').
nombreKdrama('be_melodramatic').
nombreKdrama('doom_at_your_service').
nombreKdrama('you_are_my_spring').
nombreKdrama('the_one_and_only').
nombreKdrama('the_raincoat_killer').
nombreKdrama('reflection_of_you').
nombreKdrama('private_lives').
nombreKdrama('she_would_never_know').
nombreKdrama('undercover').
nombreKdrama('revolutionary_sisters').
nombreKdrama('young_lady_and_gentleman').
nombreKdrama('a_piece_of_your_mind').
nombreKdrama('kings_affection').
nombreKdrama('the_road_tragedy_of_one').
nombreKdrama('doctor_lawyer').
nombreKdrama('why_her').
nombreKdrama('bloody_heart').
nombreKdrama('cafe_minamdang').
nombreKdrama('insider').
nombreKdrama('joseon_attorney').
nombreKdrama('queen_for_seven_days').
nombreKdrama('radiant_office').
nombreKdrama('save_me').
nombreKdrama('missing_the_other_side').
nombreKdrama('beautiful_gong_shim').
nombreKdrama('temperature_of_love').
nombreKdrama('the_greatest_love').
nombreKdrama('fated_to_love_you').
nombreKdrama('oh_my_ghost').
nombreKdrama('witch_at_court').
nombreKdrama('the_time_we_were_not_in_love').
nombreKdrama('falling_for_innocence').
nombreKdrama('the_liar_and_his_lover').
nombreKdrama('the_lovers_of_the_red_sky').
nombreKdrama('shopping_king_louie').
nombreKdrama('weightlifting_fairy_kim_bok_joo').
nombreKdrama('goodbye_to_goodbye').
nombreKdrama('secret_love_affair').
nombreKdrama('the_good_witch').
nombreKdrama('the_flames_of_desire').
nombreKdrama('golden_time').
nombreKdrama('angel_eyes').
nombreKdrama('the_beauty_inside').
nombreKdrama('another_miss_oh').
nombreKdrama('legend_of_the_blue_sea').
nombreKdrama('shine_or_go_crazy').
nombreKdrama('gu_family_book').
nombreKdrama('cinderella_and_four_knights').
nombreKdrama('you_who_came_from_the_stars').
nombreKdrama('what_s_wrong_with_secretary_kim').
nombreKdrama('to_the_beautiful_you').
nombreKdrama('scarlet_heart').
nombreKdrama('the_lovers_in_prague').
nombreKdrama('pasta').
nombreKdrama('her_lovely_heels').
nombreKdrama('hot_stove_league').
nombreKdrama('united_we_stand').
nombreKdrama('when_the_camellia_blooms').
nombreKdrama('strongest_chil_woo').
nombreKdrama('cheer_up_mr_lee').
nombreKdrama('marry_me_now').
nombreKdrama('angel_s_choice').
nombreKdrama('eternal_love').
nombreKdrama('when_time_stopped').
nombreKdrama('secret_of_the_three_kingdoms').
nombreKdrama('love_revolution').
nombreKdrama('queen_of_rings').
nombreKdrama('mad_dog').
nombreKdrama('time').
nombreKdrama('miss_hammurabi').
nombreKdrama('money_flower').
...
generoKdrama6('herederos','romance').
generoKdrama7('startup','romance').
generoKdrama8('my_love_from_the_star','romance').
generoKdrama9('goblin','fantasia').
generoKdrama10('the_king_eternal_monarch','fantasia').
generoKdrama11('it_s_okay_to_not_be_okay','romance').
generoKdrama12('the_legend_of_the_blue_sea','romance').
generoKdrama13('the_heirs','romance').
generoKdrama14('aterrizaje_emergencia_en_tu_corazon','romance').
generoKdrama15('itaewon_class','romance').
generoKdrama16('true_beauty','romance').
generoKdrama17('love_alarm','romance').
generoKdrama18('strong_woman_do_bong_soon', 'comedia').
generoKdrama19('weightlifting_fairy_kim_bok_joo', 'escolar').
generoKdrama20('while_you_were_sleeping', 'fantasia').
generoKdrama21('w_two_worlds', 'ciencia_ficcion').
generoKdrama22('healer', 'accion').
generoKdrama23('pinocchio', 'drama').
generoKdrama24('city_hunter', 'accion').
generoKdrama25('boys_over_flowers', 'romance').
generoKdrama26('dream_high', 'musical').
generoKdrama27('moon_lovers_scarlet_heart_ryeo', 'historico').
generoKdrama28('my_id_is_gangnam_beauty', 'escolar').
generoKdrama29('extraordinary_you', 'fantasia').
generoKdrama30('hwarang', 'historico').
generoKdrama31('the_master_sun', 'misterio').
generoKdrama32('doctor_stranger', 'medicina').
generoKdrama33('dr_romantic', 'medicina').
generoKdrama34('good_doctor', 'medicina').
generoKdrama35('hospital_playlist', 'drama').
generoKdrama36('signal', 'crimen').
generoKdrama37('reply_1988', 'slice_of_life').
generoKdrama38('reply_1997', 'romance').
generoKdrama39('reply_1994', 'slice_of_life').
generoKdrama40('youth_of_may', 'historico').
generoKdrama41('navillera', 'drama').
generoKdrama42('the_sound_of_magic', 'musical').
generoKdrama43('sky_castle', 'misterio').
generoKdrama44('the_world_of_the_married', 'drama').
generoKdrama45('arthdal_chronicles', 'fantasia').
generoKdrama46('mouse', 'thriller').
generoKdrama47('taxi_driver', 'accion').
generoKdrama48('law_school', 'legal').
generoKdrama49('uncontrollably_fond', 'melodrama').
generoKdrama50('the_penthouse', 'drama').
generoKdrama51('romance_is_a_bonus_book', 'romance').
generoKdrama52('because_this_is_my_first_life', 'romance').
generoKdrama53('cheese_in_the_trap', 'romance').
generoKdrama54('her_private_life', 'comedia').
generoKdrama55('the_undateables', 'comedia').
generoKdrama56('live_up_to_your_name', 'fantasia').
generoKdrama57('forest', 'romance').
generoKdrama58('oh_my_venus', 'romance').
generoKdrama59('the_light_in_your_eyes', 'drama').
generoKdrama60('something_in_the_rain', 'romance').
generoKdrama61('search_www', 'drama').
generoKdrama62('secret_garden', 'fantasia').
generoKdrama63('protect_the_boss', 'comedia').
generoKdrama64('strongest_deliveryman', 'comedia').
generoKdrama65('the_k2', 'accion').
generoKdrama66('black', 'misterio').
generoKdrama67('beautiful_mind', 'medicina').
generoKdrama68('white_christmas', 'thriller').
generoKdrama69('the_guest', 'horror').
generoKdrama70('train_to_busan_the_series', 'accion').
generoKdrama71('empress_ki', 'historico').
generoKdrama72('man_to_man', 'accion').
generoKdrama73('misty', 'drama').
generoKdrama74('flower_of_evil', 'thriller').
generoKdrama75('kingdom', 'historico').
generoKdrama76('love_in_the_moonlight', 'historico').
generoKdrama77('cheer_up', 'escolar').
generoKdrama78('doctors', 'medicina').
generoKdrama79('prison_playbook', 'drama').
generoKdrama80('strangers_from_hell', 'thriller').
generoKdrama81('alice', 'ciencia_ficcion').
generoKdrama82('mrs_cop', 'crimen').
generoKdrama83('class_of_lies', 'escolar').
generoKdrama84('the_last_empress', 'historico').
generoKdrama85('vagabond', 'accion').
generoKdrama86('life_on_mars', 'ciencia_ficcion').
generoKdrama87('shine_or_go_crazy', 'historico').
generoKdrama88('the_crowned_clown', 'historico').
generoKdrama89('blood', 'fantasia').
generoKdrama90('zombie_detective', 'horror').
generoKdrama91('my_secret_terrius', 'accion').
generoKdrama92('kairos', 'thriller').
generoKdrama93('the_great_show', 'comedia').
generoKdrama94('angel_s_last_mission_love', 'fantasia').
generoKdrama95('run_on', 'romance').
generoKdrama96('into_the_ring', 'comedia').
generoKdrama97('dali_and_cocky_prince', 'comedia').
generoKdrama98('school_2021', 'escolar').
generoKdrama99('the_veil', 'accion').
generoKdrama100('inspector_koo', 'misterio').
generoKdrama101('yumi_s_cells', 'fantasia').
generoKdrama102('the_red_sleeve', 'historico').
generoKdrama103('my_name', 'thriller').
generoKdrama104('hometown_cha_cha_cha', 'romance').
generoKdrama105('melancholia', 'drama').
generoKdrama106('happiness', 'thriller').
generoKdrama107('now_we_are_breaking_up', 'romance').
generoKdrama108('the_law_cafe', 'legal').
generoKdrama109('big_mouth', 'misterio').
generoKdrama110('love_in_contract', 'comedia').
generoKdrama111('alchemy_of_souls', 'fantasia').
generoKdrama112('juvenile_justice', 'legal').
generoKdrama113('all_of_us_are_dead', 'horror').
generoKdrama114('our_beloved_summer', 'romance').
generoKdrama115('a_business_proposal', 'comedia').
generoKdrama116('thirty_nine', 'drama').
generoKdrama117('through_the_darkness', 'crimen').
generoKdrama118('again_my_life', 'accion').
generoKdrama119('love_all_play', 'deporte').
generoKdrama120('clean_with_passion_for_now', 'comedia').
generoKdrama121('be_melodramatic', 'drama').
generoKdrama122('doom_at_your_service', 'fantasia').
generoKdrama123('you_are_my_spring', 'romance').
generoKdrama124('the_one_and_only', 'melodrama').
generoKdrama125('the_raincoat_killer', 'documental').
generoKdrama126('reflection_of_you', 'drama').
generoKdrama127('private_lives', 'misterio').
generoKdrama128('she_would_never_know', 'romance').
generoKdrama129('undercover', 'accion').
generoKdrama130('revolutionary_sisters', 'comedia').
generoKdrama131('young_lady_and_gentleman', 'drama').
generoKdrama132('a_piece_of_your_mind', 'romance').
generoKdrama133('kings_affection', 'historico').
generoKdrama134('the_road_tragedy_of_one', 'thriller').
generoKdrama135('doctor_lawyer', 'medicina').
generoKdrama136('why_her', 'legal').
generoKdrama137('bloody_heart', 'historico').
generoKdrama138('cafe_minamdang', 'misterio').
generoKdrama139('insider', 'thriller').
generoKdrama140('joseon_attorney', 'historico').
generoKdrama141('queen_for_seven_days', 'historico').
generoKdrama142('radiant_office', 'comedia').
generoKdrama143('save_me', 'thriller').
generoKdrama144('missing_the_other_side', 'fantasia').
generoKdrama145('beautiful_gong_shim', 'comedia').
generoKdrama146('temperature_of_love', 'romance').
generoKdrama147('the_greatest_love', 'comedia').
generoKdrama148('fated_to_love_you', 'romance').
generoKdrama149('oh_my_ghost', 'fantasia').
generoKdrama150('witch_at_court', 'legal').
generoKdrama151('the_time_we_were_not_in_love', 'romance').
generoKdrama152('falling_for_innocence', 'drama').
generoKdrama153('the_liar_and_his_lover', 'musical').
generoKdrama154('the_lovers_of_the_red_sky', 'historico').
generoKdrama155('shopping_king_louie', 'comedia').
generoKdrama156('weightlifting_fairy_kim_bok_joo', 'escolar').
generoKdrama157('goodbye_to_goodbye', 'drama').
generoKdrama158('secret_love_affair', 'romance').
generoKdrama159('the_good_witch', 'fantasia').
generoKdrama160('the_flames_of_desire', 'melodrama').
generoKdrama161('golden_time', 'medicina').
generoKdrama162('angel_eyes', 'drama').
generoKdrama163('the_beauty_inside', 'fantasia').
generoKdrama164('another_miss_oh', 'comedia').
generoKdrama165('legend_of_the_blue_sea', 'fantasia').
generoKdrama166('shine_or_go_crazy', 'historico').
generoKdrama167('gu_family_book', 'historico').
generoKdrama168('cinderella_and_four_knights', 'romance').
generoKdrama169('you_who_came_from_the_stars', 'ciencia_ficcion').
generoKdrama170('what_s_wrong_with_secretary_kim', 'comedia').
generoKdrama171('to_the_beautiful_you', 'escolar').
generoKdrama172('scarlet_heart', 'historico').
generoKdrama173('the_lovers_in_prague', 'romance').
generoKdrama174('pasta', 'comedia').
generoKdrama175('her_lovely_heels', 'romance').
generoKdrama176('hot_stove_league', 'deporte').
generoKdrama177('united_we_stand', 'accion').
generoKdrama178('when_the_camellia_blooms', 'romance').
generoKdrama179('strongest_chil_woo', 'historico').
generoKdrama180('cheer_up_mr_lee', 'comedia').
generoKdrama181('marry_me_now', 'drama').
generoKdrama182('angel_s_choice', 'melodrama').
generoKdrama183('eternal_love', 'fantasia').
generoKdrama184('when_time_stopped', 'fantasia').
generoKdrama185('secret_of_the_three_kingdoms', 'historico').
generoKdrama186('love_revolution', 'escolar').
generoKdrama187('queen_of_rings', 'fantasia').
generoKdrama188('mad_dog', 'accion').
generoKdrama189('time', 'melodrama').
generoKdrama190('miss_hammurabi', 'legal').
generoKdrama191('money_flower', 'drama').
generoKdrama192('four_legendary_witches', 'fantasia').
generoKdrama193('popets', 'fantasia').


actuo_en1('lee_min_ho','herederos').
actuo_en2('park_shin_hye','herederos').
actuo_en3('hyun_bin', 'crash_landing_on_you').
actuo_en4('son_ye_jin', 'crash_landing_on_you').
actuo_en5('hyun_bin', 'aterrizaje_emergencia_en_tu_corazon').
actuo_en6('kim_so_hyun','goblin').
actuo_en7('chan_eun_woo','true_beauty').
actuo_en8('song_kang','love_alarm').
actuo_en9('song_jong_ki','descendants_of_the_sun').
actuo_en10('kim_ji_won','descendants_of_the_sun').
actuo_en11('song_jong_ki','vicenzo').
actuo_en12('iu', 'hotel_del_luna').
actuo_en13('yeo_jin_goo', 'hotel_del_luna').
actuo_en14('bae_suzy', 'startup').
actuo_en15('nam_joo_hyuk', 'startup').
actuo_en16('kim_soo_hyun', 'my_love_from_the_star').
actuo_en17('jun_ji_hyun', 'my_love_from_the_star').
actuo_en18('lee_min_ho', 'the_king_eternal_monarch').
actuo_en19('kim_go_eun', 'the_king_eternal_monarch').
actuo_en20('kim_soo_hyun', 'it_s_okay_to_not_be_okay').
actuo_en21('seo_ye_ji', 'it_s_okay_to_not_be_okay').
actuo_en22('lee_min_ho', 'the_legend_of_the_blue_sea').
actuo_en23('jun_ji_hyun', 'the_legend_of_the_blue_sea').
actuo_en24('park_seo_joon', 'itaewon_class').
actuo_en25('kim_da_mi', 'itaewon_class').
actuo_en26('moon_ga_young', 'true_beauty').
...
subtitulos('frances').
subtitulos('aleman').
subtitulos('portugues').
subtitulos('japones').
subtitulos('coreano').
subtitulos('chino').

%subtitulos de kdramas
subtitulo_de_kdrama1('2521',[espanol,ingles,coreano,chino,japones]).
subtitulo_de_kdrama2('crash_landing_on_you',[espanol,ingles,coreano,chino,japones]).
subtitulo_de_kdrama3('descendants_of_the_sun',[espanol,ingles,coreano,chino,japones]).
subtitulo_de_kdrama4('vicenzo',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama5('hotel_del_luna',[espanol,japones]).
subtitulo_de_kdrama6('herederos',[espanol,ingles,coreano]).
subtitulo_de_kdrama7('startup',[espanol,ingles,coreano,chino,japones,frances]).
subtitulo_de_kdrama8('my_love_from_the_star',[coreano,chino,japones]).
subtitulo_de_kdrama9('goblin',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama10('the_king_eternal_monarch',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama11('it_s_okay_to_not_be_okay',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama12('the_legend_of_the_blue_sea',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama13('the_heirs',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama14('aterrizaje_emergencia_en_tu_corazon',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama15('itaewon_class',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama16('true_beauty',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama17('love_alarm',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama18('strong_woman_do_bong_soon',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama19('weightlifting_fairy_kim_bok_joo',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama20('while_you_were_sleeping',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama21('w_two_worlds',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama22('healer',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama23('pinocchio',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama24('city_hunter',[espanol,ingles,coreano,chino,japones,frances,aleman,chino,portugues]).
subtitulo_de_kdrama25('heirs',[espanol,frances,corean,japones]).
subtitulo_de_kdrama26('dream_high',[espanol,ingles,coreano,chino,japones]).
subtitulo_de_kdrama27('moon_lovers_scarlet_heart_ryeo',[espanol,ingles,coreano,japones]).
subtitulo_de_kdrama28('my_id_is_gangnam_beauty',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama29('extraordinary_you',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama30('hwarang',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama31('the_master_sun',[espanol,ingles,coreano,japones]).
subtitulo_de_kdrama32('doctor_stranger',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama33('dr_romantic',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama34('good_doctor',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama35('hospital_playlist',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama36('signal',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama37('reply_1988',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama38('reply_1997',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama39('reply_1994',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama40('youth_of_may',[espanol,ingles,coreano,chino,japones,frances,aleman]).
subtitulo_de_kdrama41('navillera',[coreano,chino,japones]).
subtitulo_de_kdrama42('the_sound_of_magic',[coreano,chino,japones]).
subtitulo_de_kdrama43('sky_castle',[coreano,chino,japones]).
subtitulo_de_kdrama44('the_world_of_the_married',[coreano,chino,japones]).
subtitulo_de_kdrama45('arthdal_chronicles',[coreano,chino,japones]).
subtitulo_de_kdrama46('mouse',[coreano,chino,japones]).
subtitulo_de_kdrama47('taxi_driver',[coreano,chino,japones]).
subtitulo_de_kdrama48('law_school',[coreano,chino,japones]).
subtitulo_de_kdrama49('uncontrollably_fond',[coreano,chino,japones]).
subtitulo_de_kdrama50('the_penthouse',[coreano,chino,japones]).
subtitulo_de_kdrama51('romance_is_a_bonus_book',[coreano,chino,japones]).
subtitulo_de_kdrama52('because_this_is_my_first_life',[coreano,chino,japones]).
subtitulo_de_kdrama53('cheese_in_the_trap',[coreano,chino,japones]).
subtitulo_de_kdrama54('her_private_life',[coreano,chino,japones]).
subtitulo_de_kdrama55('the_undateables' ,[coreano,chino,japones]).
subtitulo_de_kdrama56('live_up_to_your_name',[coreano,chino,japones]).
subtitulo_de_kdrama57('forest',[coreano,chino,japones]).
subtitulo_de_kdrama58('oh_my_venus',[coreano,chino,japones]).
subtitulo_de_kdrama59('the_light_in_your_eyes',[coreano,chino,japones]).
subtitulo_de_kdrama60('something_in_the_rain',[coreano,chino,japones]).
subtitulo_de_kdrama61('search_www',[coreano,chino,japones]).
subtitulo_de_kdrama62('secret_garden',[coreano,chino,japones]).
subtitulo_de_kdrama63('protect_the_boss',[coreano,chino,japones]).
subtitulo_de_kdrama64('strongest_deliveryman',[coreano,chino,japones]).
subtitulo_de_kdrama65('the_k2',[coreano,chino,japones]).
subtitulo_de_kdrama66('black',[coreano,chino,japones]).
subtitulo_de_kdrama67('beautiful_mind',[coreano,chino,japones]).
subtitulo_de_kdrama68('white_christmas',[coreano,chino,japones]).
subtitulo_de_kdrama69('the_guest',[coreano,chino,japones]).
subtitulo_de_kdrama70('train_to_busan_the_series',[coreano,chino,japones]).
subtitulo_de_kdrama71('empress_ki',[coreano,chino,japones]).
subtitulo_de_kdrama72('man_to_man',[coreano,chino,japones]).
subtitulo_de_kdrama73('misty',[coreano,chino,japones]).
subtitulo_de_kdrama74('flower_of_evil',[coreano,chino,japones]).
subtitulo_de_kdrama75('kingdom',[coreano,chino,japones]).
subtitulo_de_kdrama76('love_in_the_moonlight',[coreano,chino,japones]).
subtitulo_de_kdrama77('cheer_up',[coreano,chino,japones]).
subtitulo_de_kdrama78('doctors',[coreano,chino,japones]).
subtitulo_de_kdrama79('prison_playbook',[coreano,chino,japones]).
subtitulo_de_kdrama80('strangers_from_hell',[espanol,coreano,chino,japones]).
subtitulo_de_kdrama81('alice',[coreano,chino,japones]).
subtitulo_de_kdrama82('mrs_cop',[coreano,chino,japones]).
subtitulo_de_kdrama83('class_of_lies',[coreano,chino,japones,ingles]).
subtitulo_de_kdrama84('the_last_empress',[coreano,chino,japones]).
subtitulo_de_kdrama85('vagabond',[coreano,chino,japones]).
subtitulo_de_kdrama86('life_on_mars' ,[coreano,chino,japones]).
subtitulo_de_kdrama87('shine_or_go_crazy',[coreano,chino,japones]).
subtitulo_de_kdrama88('the_crowned_clown',[coreano,chino,japones]).
subtitulo_de_kdrama89('blood',[coreano,chino,japones]).
subtitulo_de_kdrama90('zombie_detective',[coreano,chino,japones]).
subtitulo_de_kdrama91('my_secret_terrius',[coreano,chino,japones]).
subtitulo_de_kdrama92('kairos',[coreano,chino,japones]).
subtitulo_de_kdrama93('the_great_show' ,[coreano,chino,japones]).
subtitulo_de_kdrama94('angel_s_last_mission_love',[coreano,chino,japones]).
subtitulo_de_kdrama95('run_on',[coreano,chino,japones]).
subtitulo_de_kdrama96('into_the_ring',[coreano,chino,japones]).
subtitulo_de_kdrama97('dali_and_cocky_prince',[coreano,chino,japones]).
subtitulo_de_kdrama98('school_2021',[coreano,chino,japones]).
subtitulo_de_kdrama99('the_veil',[coreano,chino,japones]).
subtitulo_de_kdrama100('inspector_koo',[coreano,chino,japones]).
subtitulo_de_kdrama101('yumi_s_cells',[espanol,ingles,coreano]).
subtitulo_de_kdrama102('the_red_sleeve',[espanol,ingles,coreano]).
subtitulo_de_kdrama103('my_name',[espanol,ingles,coreano]).
subtitulo_de_kdrama104('hometown_cha_cha_cha',[espanol,ingles,coreano]).
subtitulo_de_kdrama105('melancholia',[espanol,ingles,coreano]).
subtitulo_de_kdrama106('happiness',[espanol,ingles,coreano]).
subtitulo_de_kdrama107('now_we_are_breaking_up',[espanol,ingles,coreano]).
subtitulo_de_kdrama108('the_law_cafe',[espanol,ingles,coreano]).
subtitulo_de_kdrama109('big_mouth',[espanol,ingles,coreano]).
subtitulo_de_kdrama110('love_in_contract',[espanol,ingles,coreano]).
subtitulo_de_kdrama111('alchemy_of_souls',[espanol,ingles,coreano]).
subtitulo_de_kdrama112('juvenile_justice',[espanol,ingles,coreano]).
subtitulo_de_kdrama113('all_of_us_are_dead',[espanol,ingles,coreano]).
subtitulo_de_kdrama114('our_beloved_summer',[espanol,ingles,coreano]).
subtitulo_de_kdrama115('a_business_proposal',[espanol,ingles,coreano]).
subtitulo_de_kdrama116('thirty_nine',[espanol,ingles,coreano]).
subtitulo_de_kdrama117('through_the_darkness',[espanol,ingles,coreano]).
subtitulo_de_kdrama118('again_my_life',[espanol,ingles,coreano]).
subtitulo_de_kdrama119('love_all_play',[espanol,ingles,coreano]).
subtitulo_de_kdrama120('clean_with_passion_for_now',[espanol,ingles,coreano]).
subtitulo_de_kdrama121('be_melodramatic',[espanol,ingles,coreano,frances]).
subtitulo_de_kdrama122('doom_at_your_service',[espanol,ingles,coreano]).
subtitulo_de_kdrama123('you_are_my_spring',[espanol,ingles,coreano]).
subtitulo_de_kdrama124('the_one_and_only',[espanol,ingles,coreano,frances]).
subtitulo_de_kdrama125('the_raincoat_killer',[espanol,ingles,coreano]).
subtitulo_de_kdrama126('reflection_of_you',[espanol,ingles,coreano]).
subtitulo_de_kdrama127('private_lives',[espanol,ingles,coreano]).
subtitulo_de_kdrama128('she_would_never_know',[espanol,ingles,coreano]).
subtitulo_de_kdrama129('undercover',[espanol,ingles,coreano]).
subtitulo_de_kdrama130('revolutionary_sisters',[espanol,ingles,coreano]).
subtitulo_de_kdrama131('young_lady_and_gentleman',[espanol,ingles,coreano]).
subtitulo_de_kdrama132('a_piece_of_your_mind',[espanol,ingles,coreano]).
subtitulo_de_kdrama133('kings_affection',[espanol,ingles,coreano]).
subtitulo_de_kdrama134('the_road_tragedy_of_one',[espanol,ingles,coreano]).
subtitulo_de_kdrama135('doctor_lawyer',[espanol,ingles,coreano]).
subtitulo_de_kdrama136('why_her',[espanol,ingles,coreano]).
subtitulo_de_kdrama137('bloody_heart',[espanol,ingles,coreano]).
subtitulo_de_kdrama138('cafe_minamdang',[espanol,ingles,coreano]).
subtitulo_de_kdrama139('insider',[espanol,ingles,coreano]).
subtitulo_de_kdrama140('joseon_attorney',[espanol,ingles,coreano]).
subtitulo_de_kdrama141('queen_for_seven_days',[espanol,ingles,coreano]).
subtitulo_de_kdrama142('radiant_office',[espanol,ingles,coreano]).
subtitulo_de_kdrama143('save_me',[espanol,ingles,coreano]).
subtitulo_de_kdrama144('missing_the_other_side',[espanol,ingles,coreano]).
subtitulo_de_kdrama145('beautiful_gong_shim',[espanol,ingles,coreano]).
subtitulo_de_kdrama146('temperature_of_love',[espanol,ingles,coreano]).
subtitulo_de_kdrama147('the_greatest_love',[espanol,ingles,coreano]).
subtitulo_de_kdrama148('fated_to_love_you',[espanol,ingles,coreano]).
subtitulo_de_kdrama149('oh_my_ghost',[espanol,ingles,coreano]).
subtitulo_de_kdrama150('witch_at_court',[espanol,ingles,coreano]).
subtitulo_de_kdrama151('the_time_we_were_not_in_love',[espanol,ingles,coreano]).
subtitulo_de_kdrama152('falling_for_innocence',[espanol,ingles,coreano]).
subtitulo_de_kdrama153('the_liar_and_his_lover',[espanol,ingles,coreano]).
subtitulo_de_kdrama154('the_lovers_of_the_red_sky',[espanol,ingles,coreano]).
subtitulo_de_kdrama155('shopping_king_louie',[espanol,ingles,coreano]).
subtitulo_de_kdrama156('weightlifting_fairy_kim_bok_joo',[espanol,ingles,coreano]).
subtitulo_de_kdrama157('goodbye_to_goodbye',[espanol,ingles,coreano]).
subtitulo_de_kdrama158('secret_love_affair',[espanol,ingles,coreano]).
subtitulo_de_kdrama159('the_good_witch',[espanol,ingles,coreano]).
subtitulo_de_kdrama160('the_flames_of_desire',[espanol,ingles,coreano]).
subtitulo_de_kdrama161('golden_time',[espanol,ingles,coreano]).
subtitulo_de_kdrama162('angel_eyes',[espanol,ingles,coreano]).
subtitulo_de_kdrama163('the_beauty_inside',[espanol,ingles,coreano]).
subtitulo_de_kdrama164('another_miss_oh',[espanol,ingles,coreano]).
subtitulo_de_kdrama165('legend_of_the_blue_sea',[espanol,ingles,coreano]).
subtitulo_de_kdrama166('shine_or_go_crazy',[espanol,ingles,coreano]).
subtitulo_de_kdrama167('gu_family_book',[espanol,ingles,coreano]).
subtitulo_de_kdrama168('cinderella_and_four_knights',[espanol,ingles,coreano]).
subtitulo_de_kdrama169('you_who_came_from_the_stars',[espanol,ingles,coreano]).
subtitulo_de_kdrama170('what_s_wrong_with_secretary_kim',[ingles,coreano]).
subtitulo_de_kdrama171('to_the_beautiful_you',[espanol,ingles,coreano]).
subtitulo_de_kdrama172('scarlet_heart',[espanol,ingles,coreano]).
subtitulo_de_kdrama173('the_lovers_in_prague',[espanol,ingles,coreano]).
subtitulo_de_kdrama174('pasta',[espanol,ingles,coreano]).
subtitulo_de_kdrama175('her_lovely_heels',[espanol,ingles,coreano]).
subtitulo_de_kdrama176('hot_stove_league',[espanol,ingles,coreano]).
subtitulo_de_kdrama177('united_we_stand',[espanol,ingles,coreano]).
subtitulo_de_kdrama178('when_the_camellia_blooms',[espanol,ingles,coreano]).
subtitulo_de_kdrama179('strongest_chil_woo',[espanol,ingles,coreano]).
subtitulo_de_kdrama180('cheer_up_mr_lee',[espanol,ingles,coreano]).
subtitulo_de_kdrama181('marry_me_now',[espanol,ingles,coreano]).
subtitulo_de_kdrama182('angel_s_choice',[espanol,ingles,coreano]).
subtitulo_de_kdrama183('eternal_love',[espanol,ingles,coreano]).
subtitulo_de_kdrama184('when_time_stopped',[espanol,ingles,coreano]).
subtitulo_de_kdrama185('secret_of_the_three_kingdoms',[espanol,ingles,coreano]).
subtitulo_de_kdrama186('love_revolution',[espanol,ingles,coreano]).
subtitulo_de_kdrama187('queen_of_rings',[espanol,ingles,coreano]).
subtitulo_de_kdrama188('mad_dog',[espanol,ingles,coreano]).
subtitulo_de_kdrama189('time',[espanol,ingles,coreano]).
subtitulo_de_kdrama190('miss_hammurabi',[espanol,ingles,coreano,frances]).

%region de corea donde fue filmado
region('seoul').
region('busan').
region('jeju').
region('chungcheong').
...
locacionKdrama11('it_s_okay_to_not_be_okay',[corea_del_sur],[seoul,jeju]).
locacionKdrama12('the_legend_of_the_blue_sea',[corea_del_sur],[seoul]).
locacionKdrama13('the_heirs',[corea_del_sur],[seoul]).
locacionKdrama14('aterrizaje_emergencia_en_tu_corazon',[corea_del_sur],[seoul]).
locacionKdrama15('itaewon_class',[corea_del_sur],[seoul]).
locacionKdrama16('true_beauty',[corea_del_sur],[seoul]).
...
locacionKdrama24('city_hunter',[corea_del_sur],[seoul]).
locacionKdrama25('boys_over_flowers',[corea_del_sur],[seoul]).
locacionKdrama26('dream_high',[corea_del_sur],[seoul]).
locacionKdrama27('moon_lovers_scarlet_heart_ryeo',[corea_del_sur],[seoul]).
locacionKdrama28('my_id_is_gangnam_beauty',[corea_del_sur],[seoul]).
locacionKdrama29('extraordinary_you',[corea_del_sur],[seoul]).
locacionKdrama30('hwarang',[corea_del_sur],[seoul]).
locacionKdrama31('the_master_sun',[corea_del_sur],[seoul]).
locacionKdrama32('doctor_stranger',[corea_del_sur],[seoul]).
locacionKdrama33('dr_romantic',[corea_del_sur],[seoul]).
locacionKdrama34('good_doctor',[corea_del_sur],[seoul]).
locacionKdrama35('hospital_playlist',[corea_del_sur],[seoul]).
locacionKdrama36('signal',[corea_del_sur],[seoul]).
...
locacionKdrama52('because_this_is_my_first_life',[corea_del_sur],[seoul]).
locacionKdrama53('cheese_in_the_trap',[corea_del_sur],[seoul]).
locacionKdrama54('her_private_life',[corea_del_sur],[seoul]).
locacionKdrama55('the_undateables',[corea_del_sur],[seoul]).
locacionKdrama56('live_up_to_your_name',[corea_del_sur],[seoul]).
locacionKdrama57('forest',[corea_del_sur],[seoul]).
locacionKdrama58('oh_my_venus',[corea_del_sur],[seoul]).
locacionKdrama59('the_light_in_your_eyes',[corea_del_sur],[seoul]).
locacionKdrama60('something_in_the_rain',[corea_del_sur],[seoul]).
locacionKdrama61('search_www',[corea_del_sur],[seoul]).
locacionKdrama62('secret_garden',[corea_del_sur],[seoul]).
locacionKdrama63('protect_the_boss',[corea_del_sur],[seoul]).
locacionKdrama64('strongest_deliveryman',[corea_del_sur],[seoul]).
locacionKdrama65('the_k2',[corea_del_sur],[seoul]).
locacionKdrama66('black',[corea_del_sur],[seoul]).
locacionKdrama67('beautiful_mind',[corea_del_sur],[seoul]).
locacionKdrama68('white_christmas',[corea_del_sur],[seoul,chungcheong]).
locacionKdrama69('the_guest',[corea_del_sur],[seoul]).
locacionKdrama70('train_to_busan_the_series',[corea_del_sur],[seoul]).
locacionKdrama71('empress_ki',[corea_del_sur],[seoul]).
locacionKdrama72('man_to_man',[corea_del_sur],[seoul]).
locacionKdrama73('misty',[corea_del_sur],[seoul]).
locacionKdrama74('flower_of_evil',[corea_del_sur],[seoul]).
locacionKdrama75('kingdom',[corea_del_sur],[seoul]).
locacionKdrama76('love_in_the_moonlight',[corea_del_sur],[seoul,chungcheong]).
locacionKdrama77('cheer_up',[corea_del_sur],[seoul]).
locacionKdrama78('doctors',[corea_del_sur],[seoul]).
locacionKdrama79('prison_playbook',[corea_del_sur],[seoul]).
locacionKdrama80('strangers_from_hell',[corea_del_sur],[seoul]).
locacionKdrama81('alice',[corea_del_sur],[seoul]).
locacionKdrama82('mrs_cop',[corea_del_sur],[seoul]).
locacionKdrama83('class_of_lies',[corea_del_sur],[seoul]).
locacionKdrama84('the_last_empress',[corea_del_sur],[seoul]).
locacionKdrama85('vagabond',[corea_del_sur],[seoul]).
locacionKdrama86('life_on_mars',[corea_del_sur],[seoul]).
locacionKdrama87('shine_or_go_crazy',[corea_del_sur],[seoul]).
locacionKdrama88('the_crowned_clown',[corea_del_sur],[seoul]).
locacionKdrama89('blood',[corea_del_sur],[seoul]).
locacionKdrama90('zombie_detective',[corea_del_sur],[seoul]).
locacionKdrama91('my_secret_terrius',[corea_del_sur],[seoul]).
locacionKdrama92('kairos',[corea_del_sur],[seoul]).
locacionKdrama93('the_great_show',[corea_del_sur],[seoul]).
locacionKdrama94('angel_s_last_mission_love',[corea_del_sur],[seoul,chungcheong]).
locacionKdrama95('run_on',[corea_del_sur],[seoul]).
locacionKdrama96('into_the_ring',[corea_del_sur],[seoul]).
locacionKdrama97('dali_and_cocky_prince',[corea_del_sur],[seoul]).
locacionKdrama98('school_2021',[corea_del_sur],[seoul]).
locacionKdrama99('the_veil',[corea_del_sur],[seoul]).
locacionKdrama100('inspector_koo',[corea_del_sur],[seoul]).
locacionKdrama101('cinderella_and_four_knights',[corea_del_sur],[seoul]).
locacionKdrama102('you_who_came_from_the_stars',[corea_del_sur],[seoul]).
locacionKdrama103('what_s_wrong_with_secretary_kim',[corea_del_sur],[seoul]).
locacionKdrama104('to_the_beautiful_you',[corea_del_sur],[seoul]).
locacionKdrama105('scarlet_heart',[corea_del_sur],[seoul]).
locacionKdrama106('the_lovers_in_prague',[corea_del_sur],[seoul,chungcheong]).
locacionKdrama107('pasta',[corea_del_sur],[seoul]).
locacionKdrama108('her_lovely_heels',[corea_del_sur],[seoul]).
locacionKdrama109('hot_stove_league',[corea_del_sur],[seoul]).
locacionKdrama110('united_we_stand',[corea_del_sur],[seoul]).
locacionKdrama111('when_the_camellia_blooms',[corea_del_sur],[seoul]).
locacionKdrama112('strongest_chil_woo',[corea_del_sur],[seoul]).
locacionKdrama113('cheer_up_mr_lee',[corea_del_sur],[seoul]).
locacionKdrama114('marry_me_now',[corea_del_sur],[seoul]).
locacionKdrama115('angel_s_choice',[corea_del_sur],[seoul]).
locacionKdrama116('eternal_love',[corea_del_sur],[seoul]).
locacionKdrama117('when_time_stopped',[corea_del_sur],[seoul]).
locacionKdrama118('secret_of_the_three_kingdoms',[corea_del_sur],[seoul,chungcheong]).
locacionKdrama119('love_revolution',[corea_del_sur],[seoul]).
locacionKdrama120('queen_of_rings',[corea_del_sur],[seoul]).
locacionKdrama121('mad_dog',[corea_del_sur],[seoul]).
locacionKdrama122('time',[corea_del_sur],[seoul]).
...
clasificacion_kdrama1('2521','15','Mayores de 15').
clasificacion_kdrama2('crash_landing_on_you','15','Mayores de 15').
clasificacion_kdrama3('it_s_okay_to_not_be_okay','15','Mayores de 15').
clasificacion_kdrama4('start_up','15','Mayores de 15').
clasificacion_kdrama4('vicenzo','15','Mayores de 15').
clasificacion_kdrama5('hotel_del_luna','15','Mayores de 15').
clasificacion_kdrama6('herederos','15','Mayores de 15').
clasificacion_kdrama7('startup','15','Mayores de 15').
clasificacion_kdrama8('my_love_from_the_star','15','Mayores de 15').
clasificacion_kdrama9('goblin','15','Mayores de 15').
clasificacion_kdrama10('the_king_eternal_monarch','15','Mayores de 15').
clasificacion_kdrama11('the_legend_of_the_blue_sea','15','Mayores de 15').
clasificacion_kdrama12('aterrizaje_emergencia_en_tu_corazon','15','Mayores de 15').
clasificacion_kdrama13('itaewon_class','15','Mayores de 15').
clasificacion_kdrama14('true_beauty','15','Mayores de 15').
clasificacion_kdrama15('love_alarm','15','Mayores de 15').
clasificacion_kdrama16('strong_woman_do_bong_soon','15','Mayores de 15').
clasificacion_kdrama17('weightlifting_fairy_kim_bok_joo','15','Mayores de 15').
clasificacion_kdrama18('while_you_were_sleeping','15','Mayores de 15').
clasificacion_kdrama19('w_two_worlds','15','Mayores de 15').
clasificacion_kdrama20('healer','15','Mayores de 15').
clasificacion_kdrama21('pinocchio','15','Mayores de 15').
clasificacion_kdrama22('city_hunter','15','Mayores de 15').
clasificacion_kdrama23('boys_over_flowers','15','Mayores de 15').
clasificacion_kdrama24('dream_high','15','Mayores de 15').
clasificacion_kdrama25('moon_lovers_scarlet_heart_ryeo','15','Mayores de 15').
clasificacion_kdrama26('my_id_is_gangnam_beauty','15','Mayores de 15').
clasificacion_kdrama27('extraordinary_you','15','Mayores de 15').
clasificacion_kdrama28('hwarang','15','Mayores de 15').
clasificacion_kdrama29('the_master_sun','15','Mayores de 15').
clasificacion_kdrama30('doctor_stranger','15','Mayores de 15').
clasificacion_kdrama31('dr_romantic','15','Mayores de 15').
clasificacion_kdrama32('good_doctor','15','Mayores de 15').
clasificacion_kdrama33('hospital_playlist','15','Mayores de 15').
clasificacion_kdrama34('signal','15','Mayores de 15').
clasificacion_kdrama35('reply_1988','15','Mayores de 15').
clasificacion_kdrama36('reply_1997','15','Mayores de 15').
clasificacion_kdrama37('reply_1994','15','Mayores de 15').
clasificacion_kdrama38('youth_of_may','15','Mayores de 15').
clasificacion_kdrama39('navillera','15','Mayores de 15').
clasificacion_kdrama40('the_sound_of_magic','15','Mayores de 15').
clasificacion_kdrama41('sky_castle','15','Mayores de 15').
clasificacion_kdrama42('the_world_of_the_married','15','Mayores de 15').
clasificacion_kdrama43('arthdal_chronicles','15','Mayores de 15').
clasificacion_kdrama44('mouse','15','Mayores de 15').
clasificacion_kdrama45('taxi_driver','15','Mayores de 15').
clasificacion_kdrama46('law_school','15','Mayores de 15').
clasificacion_kdrama47('uncontrollably_fond','15','Mayores de 15').
clasificacion_kdrama48('the_penthouse','15','Mayores de 15').
clasificacion_kdrama49('romance_is_a_bonus_book','15','Mayores de 15').
clasificacion_kdrama50('because_this_is_my_first_life','15','Mayores de 15').
clasificacion_kdrama51('romance_is_a_bonus_book','15','Mayores de 15').
clasificacion_kdrama52('because_this_is_my_first_life','15','Mayores de 15').
clasificacion_kdrama53('cheese_in_the_trap','15','Mayores de 15').
clasificacion_kdrama54('her_private_life','15','Mayores de 15').
clasificacion_kdrama55('the_undateables','15','Mayores de 15').
clasificacion_kdrama56('live_up_to_your_name','15','Mayores de 15').
clasificacion_kdrama57('forest','15','Mayores de 15').
clasificacion_kdrama58('oh_my_venus','15','Mayores de 15').
clasificacion_kdrama59('the_light_in_your_eyes','15','Mayores de 15').
clasificacion_kdrama60('something_in_the_rain','15','Mayores de 15').
clasificacion_kdrama61('search_www','15','Mayores de 15').
clasificacion_kdrama62('secret_garden','15','Mayores de 15').
clasificacion_kdrama63('protect_the_boss','15','Mayores de 15').
clasificacion_kdrama64('strongest_deliveryman','15','Mayores de 15').
clasificacion_kdrama65('the_k2','15','Mayores de 15').
clasificacion_kdrama66('black','15','Mayores de 15').
clasificacion_kdrama67('beautiful_mind','15','Mayores de 15').
clasificacion_kdrama68('white_christmas','15','Mayores de 15').
clasificacion_kdrama69('the_guest','15','Mayores de 15').
clasificacion_kdrama70('train_to_busan_the_series','15','Mayores de 15').
clasificacion_kdrama71('empress_ki','15','Mayores de 15').
clasificacion_kdrama72('man_to_man','15','Mayores de 15').
clasificacion_kdrama73('misty','15','Mayores de 15').
clasificacion_kdrama74('flower_of_evil','15','Mayores de 15').
clasificacion_kdrama75('kingdom','15','Mayores de 15').
clasificacion_kdrama76('love_in_the_moonlight','15','Mayores de 15').
clasificacion_kdrama77('cheer_up','15','Mayores de 15').
clasificacion_kdrama78('doctors','15','Mayores de 15').
clasificacion_kdrama79('prison_playbook','15','Mayores de 15').
clasificacion_kdrama80('strangers_from_hell','15','Mayores de 15').
clasificacion_kdrama81('alice','15','Mayores de 15').
clasificacion_kdrama82('mrs_cop','15','Mayores de 15').
clasificacion_kdrama83('class_of_lies','15','Mayores de 15').
clasificacion_kdrama84('the_last_empress','15','Mayores de 15').
clasificacion_kdrama85('vagabond','15','Mayores de 15').
clasificacion_kdrama86('life_on_mars','15','Mayores de 15').
clasificacion_kdrama87('shine_or_go_crazy','15','Mayores de 15').
clasificacion_kdrama88('the_crowned_clown','15','Mayores de 15').
clasificacion_kdrama89('blood','15','Mayores de 15').
clasificacion_kdrama90('zombie_detective','15','Mayores de 15').
clasificacion_kdrama91('my_secret_terrius','15','Mayores de 15').
clasificacion_kdrama92('kairos','15','Mayores de 15').
clasificacion_kdrama93('the_great_show','15','Mayores de 15').
clasificacion_kdrama94('angel_s_last_mission_love','15','Mayores de 15').
clasificacion_kdrama95('run_on','15','Mayores de 15').
clasificacion_kdrama96('into_the_ring','15','Mayores de 15').
clasificacion_kdrama97('dali_and_cocky_prince','15','Mayores de 15').
clasificacion_kdrama98('school_2021','15','Mayores de 15').
clasificacion_kdrama99('the_veil','15','Mayores de 15').
clasificacion_kdrama100('inspector_koo','15','Mayores de 15').
clasificacion_kdrama101('yumi_s_cells','15','Mayores de 15').
clasificacion_kdrama102('the_red_sleeve','15','Mayores de 15').
clasificacion_kdrama103('my_name','15','Mayores de 15').
clasificacion_kdrama104('hometown_cha_cha_cha','15','Mayores de 15').
clasificacion_kdrama105('melancholia','15','Mayores de 15').
clasificacion_kdrama106('happiness','15','Mayores de 15').
clasificacion_kdrama107('now_we_are_breaking_up','15','Mayores de 15').
clasificacion_kdrama108('the_law_cafe','15','Mayores de 15').
clasificacion_kdrama109('big_mouth','15','Mayores de 15').
clasificacion_kdrama110('love_in_contract','15','Mayores de 15').
clasificacion_kdrama111('alchemy_of_souls','15','Mayores de 15').
clasificacion_kdrama112('juvenile_justice','15','Mayores de 15').
clasificacion_kdrama113('all_of_us_are_dead','15','Mayores de 15').
clasificacion_kdrama114('our_beloved_summer','15','Mayores de 15').
clasificacion_kdrama115('a_business_proposal','15','Mayores de 15').
clasificacion_kdrama116('thirty_nine','15','Mayores de 15').
clasificacion_kdrama117('through_the_darkness','15','Mayores de 15').
clasificacion_kdrama118('again_my_life','15','Mayores de 15').
clasificacion_kdrama119('love_all_play','15','Mayores de 15').
clasificacion_kdrama120('clean_with_passion_for_now','15','Mayores de 15').
clasificacion_kdrama121('be_melodramatic','15','Mayores de 15').
clasificacion_kdrama122('doom_at_your_service','15','Mayores de 15').
clasificacion_kdrama123('you_are_my_spring','15','Mayores de 15').
clasificacion_kdrama124('the_one_and_only','15','Mayores de 15').
clasificacion_kdrama125('the_raincoat_killer','15','Mayores de 15').
clasificacion_kdrama126('reflection_of_you','15','Mayores de 15').
clasificacion_kdrama127('private_lives','15','Mayores de 15').
clasificacion_kdrama128('she_would_never_know','15','Mayores de 15').
clasificacion_kdrama129('undercover','15','Mayores de 15').
clasificacion_kdrama130('revolutionary_sisters','15','Mayores de 15').
clasificacion_kdrama131('young_lady_and_gentleman','15','Mayores de 15').
clasificacion_kdrama132('a_piece_of_your_mind','15','Mayores de 15').
clasificacion_kdrama133('kings_affection','15','Mayores de 15').
clasificacion_kdrama134('the_road_tragedy_of_one','15','Mayores de 15').
clasificacion_kdrama135('doctor_lawyer','15','Mayores de 15').
clasificacion_kdrama136('why_her','15','Mayores de 15').
clasificacion_kdrama137('bloody_heart','15','Mayores de 15').
clasificacion_kdrama138('cafe_minamdang','15','Mayores de 15').
clasificacion_kdrama139('insider','15','Mayores de 15').
clasificacion_kdrama140('joseon_attorney','15','Mayores de 15').
clasificacion_kdrama141('queen_for_seven_days','15','Mayores de 15').
clasificacion_kdrama142('radiant_office','15','Mayores de 15').
clasificacion_kdrama143('save_me','15','Mayores de 15').
clasificacion_kdrama144('missing_the_other_side','15','Mayores de 15').
clasificacion_kdrama145('beautiful_gong_shim','15','Mayores de 15').
clasificacion_kdrama146('temperature_of_love','15','Mayores de 15').
clasificacion_kdrama147('the_greatest_love','15','Mayores de 15').
clasificacion_kdrama148('fated_to_love_you','15','Mayores de 15').
clasificacion_kdrama149('oh_my_ghost','15','Mayores de 15').
clasificacion_kdrama150('witch_at_court','15','Mayores de 15').
clasificacion_kdrama151('the_time_we_were_not_in_love','15','Mayores de 15').
clasificacion_kdrama152('falling_for_innocence','15','Mayores de 15').
clasificacion_kdrama153('the_liar_and_his_lover','15','Mayores de 15').
clasificacion_kdrama154('the_lovers_of_the_red_sky','15','Mayores de 15').
clasificacion_kdrama155('shopping_king_louie','15','Mayores de 15').
clasificacion_kdrama156('weightlifting_fairy_kim_bok_joo','15','Mayores de 15').
clasificacion_kdrama157('goodbye_to_goodbye','15','Mayores de 15').
clasificacion_kdrama158('secret_love_affair','15','Mayores de 15').
clasificacion_kdrama159('the_good_witch','15','Mayores de 15').
clasificacion_kdrama160('the_flames_of_desire','15','Mayores de 15').
clasificacion_kdrama161('golden_time','15','Mayores de 15').
clasificacion_kdrama162('angel_eyes','15','Mayores de 15').
clasificacion_kdrama163('the_beauty_inside','15','Mayores de 15').
clasificacion_kdrama164('another_miss_oh','15','Mayores de 15').
clasificacion_kdrama165('legend_of_the_blue_sea','15','Mayores de 15').
clasificacion_kdrama166('shine_or_go_crazy','15','Mayores de 15').
clasificacion_kdrama167('gu_family_book','15','Mayores de 15').
clasificacion_kdrama168('cinderella_and_four_knights','15','Mayores de 15').
clasificacion_kdrama169('you_who_came_from_the_stars','15','Mayores de 15').
clasificacion_kdrama170('what_s_wrong_with_secretary_kim','15','Mayores de 15').
clasificacion_kdrama171('to_the_beautiful_you','15','Mayores de 15').
clasificacion_kdrama172('scarlet_heart','15','Mayores de 15').
clasificacion_kdrama173('the_lovers_in_prague','15','Mayores de 15').
clasificacion_kdrama174('pasta','15','Mayores de 15').
clasificacion_kdrama175('her_lovely_heels','15','Mayores de 15').
clasificacion_kdrama176('hot_stove_league','15','Mayores de 15').
clasificacion_kdrama177('united_we_stand','15','Mayores de 15').
clasificacion_kdrama178('when_the_camellia_blooms','15','Mayores de 15').
clasificacion_kdrama179('strongest_chil_woo','15','Mayores de 15').
clasificacion_kdrama180('the_king_in_love','15','Mayores de 15').
clasificacion_kdrama181('the_king_2hearts','15','Mayores de 15').
clasificacion_kdrama182('the_king_eternal_monarch','15','Mayores de 15').
clasificacion_kdrama183('the_kings_daughter_so_baek_hyang','15','Mayores de 15').
clasificacion_kdrama184('the_kings_face','15','Mayores de 15').
clasificacion_kdrama185('secret_of_the_three_kingdoms','15','Mayores de 15').
clasificacion_kdrama186('love_revolution','15','Mayores de 15').
clasificacion_kdrama187('queen_of_rings','15','Mayores de 15').
clasificacion_kdrama188('mad_dog','15','Mayores de 15').
clasificacion_kdrama189('time','15','Mayores de 15').
...
kdramas_subtitulados_en_espanol(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(espanol, Idiomas).

%¿Cuales son los kdrama subtitulados en ingles?
% Regla que encuentra los Kdramas subtitulados en ingles
kdramas_subtitulados_en_ingles(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(ingles, Idiomas).

%¿Cuales son los kdrama subtitulados en frances?
% Regla que encuentra los Kdramas subtitulados en frances
kdramas_subtitulados_en_frances(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(frances, Idiomas).


%¿Cuales son los kdrama subtitulados en coreano?
% Regla que encuentra los Kdramas subtitulados en coreano
kdramas_subtitulados_en_coreano(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(coreano, Idiomas).

%¿Cuales son los kdrama subtitulados en japones?
% Regla que encuentra los Kdramas subtitulados en japones
kdramas_subtitulados_en_japones(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(japones, Idiomas).

%¿Cuales son los kdrama subtitulados en aleman?
% Regla que encuentra los Kdramas subtitulados en aleman
kdramas_subtitulados_en_aleman(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(aleman, Idiomas).

%¿Cuales son los kdrama subtitulados en portugues?
% Regla que encuentra los Kdramas subtitulados en portugues
kdramas_subtitulados_en_portugues(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(portugues, Idiomas).

%¿Cuales son los kdrama subtitulados en chino?
% Regla que encuentra los Kdramas subtitulados en chino
kdramas_subtitulados_en_chino(Kdrama) :-
    subtitulo_de_kdrama(_, Kdrama, Idiomas),
    member(chino, Idiomas).
...
;   subtitulo_de_kdrama3(Kdrama, Idiomas), Id = 3
;   subtitulo_de_kdrama4(Kdrama, Idiomas), Id = 4
;   subtitulo_de_kdrama5(Kdrama, Idiomas), Id = 5
;   subtitulo_de_kdrama6(Kdrama, Idiomas), Id = 6
;   subtitulo_de_kdrama7(Kdrama, Idiomas), Id = 7
;   subtitulo_de_kdrama8(Kdrama, Idiomas), Id = 8
;   subtitulo_de_kdrama9(Kdrama, Idiomas), Id = 9
;   subtitulo_de_kdrama10(Kdrama, Idiomas), Id = 10
;   subtitulo_de_kdrama11(Kdrama, Idiomas), Id = 11
;   subtitulo_de_kdrama12(Kdrama, Idiomas), Id = 12
;   subtitulo_de_kdrama13(Kdrama, Idiomas), Id = 13
;   subtitulo_de_kdrama14(Kdrama, Idiomas), Id = 14
;   subtitulo_de_kdrama15(Kdrama, Idiomas), Id = 15
;   subtitulo_de_kdrama16(Kdrama, Idiomas), Id = 16
;   subtitulo_de_kdrama17(Kdrama, Idiomas), Id = 17
;   subtitulo_de_kdrama18(Kdrama, Idiomas), Id = 18
;   subtitulo_de_kdrama19(Kdrama, Idiomas), Id = 19
;   subtitulo_de_kdrama20(Kdrama, Idiomas), Id = 20
;   subtitulo_de_kdrama21(Kdrama, Idiomas), Id = 21
;   subtitulo_de_kdrama22(Kdrama, Idiomas), Id = 22
;   subtitulo_de_kdrama23(Kdrama, Idiomas), Id = 23
;   subtitulo_de_kdrama24(Kdrama, Idiomas), Id = 24
;   subtitulo_de_kdrama25(Kdrama, Idiomas), Id = 25
;   subtitulo_de_kdrama26(Kdrama, Idiomas), Id = 26
;   subtitulo_de_kdrama27(Kdrama, Idiomas), Id = 27
;   subtitulo_de_kdrama28(Kdrama, Idiomas), Id = 28
;   subtitulo_de_kdrama29(Kdrama, Idiomas), Id = 29
;   subtitulo_de_kdrama30(Kdrama, Idiomas), Id = 30
;   subtitulo_de_kdrama31(Kdrama, Idiomas), Id = 31
;   subtitulo_de_kdrama32(Kdrama, Idiomas), Id = 32
;   subtitulo_de_kdrama33(Kdrama, Idiomas), Id = 33
;   subtitulo_de_kdrama34(Kdrama, Idiomas), Id = 34
;   subtitulo_de_kdrama35(Kdrama, Idiomas), Id = 35
;   subtitulo_de_kdrama36(Kdrama, Idiomas), Id = 36
;   subtitulo_de_kdrama37(Kdrama, Idiomas), Id = 37
;   subtitulo_de_kdrama38(Kdrama, Idiomas), Id = 38
;   subtitulo_de_kdrama39(Kdrama, Idiomas), Id = 39
;   subtitulo_de_kdrama40(Kdrama, Idiomas), Id = 40
;   subtitulo_de_kdrama41(Kdrama, Idiomas), Id = 41
;   subtitulo_de_kdrama42(Kdrama, Idiomas), Id = 42
;   subtitulo_de_kdrama43(Kdrama, Idiomas), Id = 43
;   subtitulo_de_kdrama44(Kdrama, Idiomas), Id = 44
;   subtitulo_de_kdrama45(Kdrama, Idiomas), Id = 45
;   subtitulo_de_kdrama46(Kdrama, Idiomas), Id = 46
;   subtitulo_de_kdrama47(Kdrama, Idiomas), Id = 47
;   subtitulo_de_kdrama48(Kdrama, Idiomas), Id = 48
;   subtitulo_de_kdrama49(Kdrama, Idiomas), Id = 49
;   subtitulo_de_kdrama50(Kdrama, Idiomas), Id = 50
;   subtitulo_de_kdrama51(Kdrama, Idiomas), Id = 51
;   subtitulo_de_kdrama52(Kdrama, Idiomas), Id = 52
;   subtitulo_de_kdrama53(Kdrama, Idiomas), Id = 53
;   subtitulo_de_kdrama54(Kdrama, Idiomas), Id = 54
;   subtitulo_de_kdrama55(Kdrama, Idiomas), Id = 55
;   subtitulo_de_kdrama56(Kdrama, Idiomas), Id = 56
;   subtitulo_de_kdrama57(Kdrama, Idiomas), Id = 57
;   subtitulo_de_kdrama58(Kdrama, Idiomas), Id = 58
;   subtitulo_de_kdrama59(Kdrama, Idiomas), Id = 59
;   subtitulo_de_kdrama60(Kdrama, Idiomas), Id = 60
;   subtitulo_de_kdrama61(Kdrama, Idiomas), Id = 61
;   subtitulo_de_kdrama62(Kdrama, Idiomas), Id = 62
;   subtitulo_de_kdrama63(Kdrama, Idiomas), Id = 63
;   subtitulo_de_kdrama64(Kdrama, Idiomas), Id = 64
;   subtitulo_de_kdrama65(Kdrama, Idiomas), Id = 65
;   subtitulo_de_kdrama66(Kdrama, Idiomas), Id = 66
;   subtitulo_de_kdrama67(Kdrama, Idiomas), Id = 67
;   subtitulo_de_kdrama68(Kdrama, Idiomas), Id = 68
;   subtitulo_de_kdrama69(Kdrama, Idiomas), Id = 69
;   subtitulo_de_kdrama70(Kdrama, Idiomas), Id = 70
;   subtitulo_de_kdrama71(Kdrama, Idiomas), Id = 71
;   subtitulo_de_kdrama72(Kdrama, Idiomas), Id = 72
;   subtitulo_de_kdrama73(Kdrama, Idiomas), Id = 73
;   subtitulo_de_kdrama74(Kdrama, Idiomas), Id = 74
;   subtitulo_de_kdrama75(Kdrama, Idiomas), Id = 75
;   subtitulo_de_kdrama76(Kdrama, Idiomas), Id = 76
;   subtitulo_de_kdrama77(Kdrama, Idiomas), Id = 77
;   subtitulo_de_kdrama78(Kdrama, Idiomas), Id = 78
;   subtitulo_de_kdrama79(Kdrama, Idiomas), Id = 79
;   subtitulo_de_kdrama80(Kdrama, Idiomas), Id = 80
;   subtitulo_de_kdrama81(Kdrama, Idiomas), Id = 81
;   subtitulo_de_kdrama82(Kdrama, Idiomas), Id = 82
;   subtitulo_de_kdrama83(Kdrama, Idiomas), Id = 83
;   subtitulo_de_kdrama84(Kdrama, Idiomas), Id = 84
;   subtitulo_de_kdrama85(Kdrama, Idiomas), Id = 85
;   subtitulo_de_kdrama86(Kdrama, Idiomas), Id = 86
;   subtitulo_de_kdrama87(Kdrama, Idiomas), Id = 87
;   subtitulo_de_kdrama88(Kdrama, Idiomas), Id = 88
;   subtitulo_de_kdrama89(Kdrama, Idiomas), Id = 89
;   subtitulo_de_kdrama90(Kdrama, Idiomas), Id = 90
;   subtitulo_de_kdrama91(Kdrama, Idiomas), Id = 91
;   subtitulo_de_kdrama92(Kdrama, Idiomas), Id = 92
;   subtitulo_de_kdrama93(Kdrama, Idiomas), Id = 93
;   subtitulo_de_kdrama94(Kdrama, Idiomas), Id = 94
;   subtitulo_de_kdrama95(Kdrama, Idiomas), Id = 95
;   subtitulo_de_kdrama96(Kdrama, Idiomas), Id = 96
;   subtitulo_de_kdrama97(Kdrama, Idiomas), Id = 97
;   subtitulo_de_kdrama98(Kdrama, Idiomas), Id = 98
;   subtitulo_de_kdrama99(Kdrama, Idiomas), Id = 99
;   subtitulo_de_kdrama100(Kdrama, Idiomas), Id = 100
;   subtitulo_de_kdrama101(Kdrama, Idiomas), Id = 101
;   subtitulo_de_kdrama102(Kdrama, Idiomas), Id = 102
;   subtitulo_de_kdrama103(Kdrama, Idiomas), Id = 103
;   subtitulo_de_kdrama104(Kdrama, Idiomas), Id = 104
;   subtitulo_de_kdrama105(Kdrama, Idiomas), Id = 105
;   subtitulo_de_kdrama106(Kdrama, Idiomas), Id = 106
;   subtitulo_de_kdrama107(Kdrama, Idiomas), Id = 107
;   subtitulo_de_kdrama108(Kdrama, Idiomas), Id = 108
;   subtitulo_de_kdrama109(Kdrama, Idiomas), Id = 109
;   subtitulo_de_kdrama110(Kdrama, Idiomas), Id = 110
;   subtitulo_de_kdrama111(Kdrama, Idiomas), Id = 111
;   subtitulo_de_kdrama112(Kdrama, Idiomas), Id = 112
;   subtitulo_de_kdrama113(Kdrama, Idiomas), Id = 113
;   subtitulo_de_kdrama114(Kdrama, Idiomas), Id = 114
;   subtitulo_de_kdrama115(Kdrama, Idiomas), Id = 115
;   subtitulo_de_kdrama116(Kdrama, Idiomas), Id = 116
;   subtitulo_de_kdrama117(Kdrama, Idiomas), Id = 117
;   subtitulo_de_kdrama118(Kdrama, Idiomas), Id = 118
;   subtitulo_de_kdrama119(Kdrama, Idiomas), Id = 119
;   subtitulo_de_kdrama120(Kdrama, Idiomas), Id = 120
;   subtitulo_de_kdrama121(Kdrama, Idiomas), Id = 121
;   subtitulo_de_kdrama122(Kdrama, Idiomas), Id = 122
;   subtitulo_de_kdrama123(Kdrama, Idiomas), Id = 123
;   subtitulo_de_kdrama124(Kdrama, Idiomas), Id = 124
;   subtitulo_de_kdrama125(Kdrama, Idiomas), Id = 125
;   subtitulo_de_kdrama126(Kdrama, Idiomas), Id = 126
;   subtitulo_de_kdrama127(Kdrama, Idiomas), Id = 127
;   subtitulo_de_kdrama128(Kdrama, Idiomas), Id = 128
;   subtitulo_de_kdrama129(Kdrama, Idiomas), Id = 129
;   subtitulo_de_kdrama130(Kdrama, Idiomas), Id = 130
;   subtitulo_de_kdrama131(Kdrama, Idiomas), Id = 131
;   subtitulo_de_kdrama132(Kdrama, Idiomas), Id = 132
;   subtitulo_de_kdrama133(Kdrama, Idiomas), Id = 133
;   subtitulo_de_kdrama134(Kdrama, Idiomas), Id = 134
;   subtitulo_de_kdrama135(Kdrama, Idiomas), Id = 135
;   subtitulo_de_kdrama136(Kdrama, Idiomas), Id = 136
;   subtitulo_de_kdrama137(Kdrama, Idiomas), Id = 137
;   subtitulo_de_kdrama138(Kdrama, Idiomas), Id = 138
;   subtitulo_de_kdrama139(Kdrama, Idiomas), Id = 139
;   subtitulo_de_kdrama140(Kdrama, Idiomas), Id = 140
;   subtitulo_de_kdrama141(Kdrama, Idiomas), Id = 141
;   subtitulo_de_kdrama142(Kdrama, Idiomas), Id = 142
;   subtitulo_de_kdrama143(Kdrama, Idiomas), Id = 143
;   subtitulo_de_kdrama144(Kdrama, Idiomas), Id = 144
;   subtitulo_de_kdrama145(Kdrama, Idiomas), Id = 145
;   subtitulo_de_kdrama146(Kdrama, Idiomas), Id = 146
;   subtitulo_de_kdrama147(Kdrama, Idiomas), Id = 147
;   subtitulo_de_kdrama148(Kdrama, Idiomas), Id = 148
;   subtitulo_de_kdrama149(Kdrama, Idiomas), Id = 149
;   subtitulo_de_kdrama150(Kdrama, Idiomas), Id = 150
;   subtitulo_de_kdrama151(Kdrama, Idiomas), Id = 151
;   subtitulo_de_kdrama152(Kdrama, Idiomas), Id = 152
;   subtitulo_de_kdrama153(Kdrama, Idiomas), Id = 153
;   subtitulo_de_kdrama154(Kdrama, Idiomas), Id = 154
;   subtitulo_de_kdrama155(Kdrama, Idiomas), Id = 155
;   subtitulo_de_kdrama156(Kdrama, Idiomas), Id = 156
;   subtitulo_de_kdrama157(Kdrama, Idiomas), Id = 157
;   subtitulo_de_kdrama158(Kdrama, Idiomas), Id = 158
;   subtitulo_de_kdrama159(Kdrama, Idiomas), Id = 159
;   subtitulo_de_kdrama160(Kdrama, Idiomas), Id = 160
;   subtitulo_de_kdrama161(Kdrama, Idiomas), Id = 161
;   subtitulo_de_kdrama162(Kdrama, Idiomas), Id = 162
;   subtitulo_de_kdrama163(Kdrama, Idiomas), Id = 163
;   subtitulo_de_kdrama164(Kdrama, Idiomas), Id = 164
;   subtitulo_de_kdrama165(Kdrama, Idiomas), Id = 165
;   subtitulo_de_kdrama166(Kdrama, Idiomas), Id = 166
;   subtitulo_de_kdrama167(Kdrama, Idiomas), Id = 167
;   subtitulo_de_kdrama168(Kdrama, Idiomas), Id = 168
;   subtitulo_de_kdrama169(Kdrama, Idiomas), Id = 169
;   subtitulo_de_kdrama170(Kdrama, Idiomas), Id = 170
;   subtitulo_de_kdrama171(Kdrama, Idiomas), Id = 171
;   subtitulo_de_kdrama172(Kdrama, Idiomas), Id = 172
;   subtitulo_de_kdrama173(Kdrama, Idiomas), Id = 173
;   subtitulo_de_kdrama174(Kdrama, Idiomas), Id = 174
;   subtitulo_de_kdrama175(Kdrama, Idiomas), Id = 175
;   subtitulo_de_kdrama176(Kdrama, Idiomas), Id = 176
;   subtitulo_de_kdrama177(Kdrama, Idiomas), Id = 177
;   subtitulo_de_kdrama178(Kdrama, Idiomas), Id = 178
;   subtitulo_de_kdrama179(Kdrama, Idiomas), Id = 179
;   subtitulo_de_kdrama180(Kdrama, Idiomas), Id = 180
;   subtitulo_de_kdrama181(Kdrama, Idiomas), Id = 181
;   subtitulo_de_kdrama182(Kdrama, Idiomas), Id = 182
;   subtitulo_de_kdrama183(Kdrama, Idiomas), Id = 183
;   subtitulo_de_kdrama184(Kdrama, Idiomas), Id = 184
;   subtitulo_de_kdrama185(Kdrama, Idiomas), Id = 185
;   subtitulo_de_kdrama186(Kdrama, Idiomas), Id = 186
;   subtitulo_de_kdrama187(Kdrama, Idiomas), Id = 187
;   subtitulo_de_kdrama188(Kdrama, Idiomas), Id = 188
;   subtitulo_de_kdrama189(Kdrama, Idiomas), Id = 189
;   subtitulo_de_kdrama190(Kdrama, Idiomas), Id = 190.


%2¿Cuales son los kdramas y sus actores?
actores_de_kdramas(Actor, Kdrama) :- actuo_en1(Actor,Kdrama)
;  actuo_en2(Actor,Kdrama)
;  actuo_en3(Actor,Kdrama)
;  actuo_en4(Actor,Kdrama)
;  actuo_en5(Actor,Kdrama)
;  actuo_en6(Actor,Kdrama)
;  actuo_en7(Actor,Kdrama)
;  actuo_en8(Actor,Kdrama)
;  actuo_en9(Actor,Kdrama)
;  actuo_en10(Actor,Kdrama)
;  actuo_en11(Actor,Kdrama)
;  actuo_en12(Actor,Kdrama)
;  actuo_en13(Actor,Kdrama)
;  actuo_en14(Actor,Kdrama)
;  actuo_en15(Actor,Kdrama)
;  actuo_en16(Actor,Kdrama)
;  actuo_en17(Actor,Kdrama)
;  actuo_en18(Actor,Kdrama)
;  actuo_en19(Actor,Kdrama)
;  actuo_en20(Actor,Kdrama)
;  actuo_en21(Actor,Kdrama)
;  actuo_en22(Actor,Kdrama)
;  actuo_en23(Actor,Kdrama)
;  actuo_en24(Actor,Kdrama)
;  actuo_en25(Actor,Kdrama)
;  actuo_en26(Actor,Kdrama).

%3¿Quien es un actor de kdramas?
es_actor_kdrama(Actor):- actuo_en1(Actor,_)
;  actuo_en2(Actor,_)
;  actuo_en3(Actor,_)
;  actuo_en4(Actor,_)
;  actuo_en5(Actor,_)
...
actor_y_su_kdrama(Actor,Kdrama) :- 
    Actor = 'lee_min_ho', actuo_en1(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en2(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en3(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en4(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en5(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en6(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en7(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en8(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en9(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en10(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en11(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en12(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en13(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en14(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en15(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en16(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en17(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en18(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en19(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en20(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en21(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en22(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en23(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en24(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en25(Actor,Kdrama)
    ; Actor = 'lee_min_ho', actuo_en26(Actor,Kdrama).

% regla que define los kdramas de fantasia 
%5¿De 100 kdramas cuales son de fantasia?
    kdramas_romance(Kdrama, Genero) :- 
    Genero = 'romance', generoKdrama1(Kdrama, Genero)
;   Genero = 'romance', generoKdrama2(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama3(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama4(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama5(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama6(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama7(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama8(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama9(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama10(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama11(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama12(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama13(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama14(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama15(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama16(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama17(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama18(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama19(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama20(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama21(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama22(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama23(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama24(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama25(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama26(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama27(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama28(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama29(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama30(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama31(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama32(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama33(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama34(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama35(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama36(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama37(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama38(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama39(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama40(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama41(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama42(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama43(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama44(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama45(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama46(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama47(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama48(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama49(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama50(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama51(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama52(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama53(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama54(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama55(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama56(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama57(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama58(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama59(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama60(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama61(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama62(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama63(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama64(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama65(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama66(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama67(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama68(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama69(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama70(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama71(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama72(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama73(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama74(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama75(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama76(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama77(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama78(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama79(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama80(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama81(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama82(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama83(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama84(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama85(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama86(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama87(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama88(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama89(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama90(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama91(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama92(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama93(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama94(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama95(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama96(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama97(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama98(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama99(Kdrama, 'romance')
;   Genero = 'romance', generoKdrama100(Kdrama,'romance').


%1regla que define los kdramas de fantasia 
%¿De 100 kdramas cuales son de fantasia?
kdramas_fantasia(Kdrama,Genero) :- 
Genero = 'fantasia', generoKdrama1(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama2(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama3(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama4(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama5(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama6(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama7(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama8(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama9(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama10(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama11(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama12(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama13(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama14(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama15(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama16(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama17(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama18(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama19(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama20(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama21(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama22(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama23(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama24(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama25(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama26(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama27(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama28(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama29(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama30(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama31(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama32(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama33(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama34(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama35(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama36(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama37(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama38(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama39(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama40(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama41(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama42(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama43(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama44(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama45(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama46(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama47(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama48(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama49(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama50(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama51(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama52(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama53(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama54(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama55(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama56(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama57(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama58(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama59(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama60(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama61(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama62(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama63(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama64(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama65(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama66(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama67(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama68(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama69(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama70(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama71(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama72(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama73(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama74(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama75(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama76(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama77(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama78(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama79(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama80(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama81(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama82(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama83(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama84(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama85(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama86(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama87(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama88(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama89(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama90(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama91(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama92(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama93(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama94(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama95(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama96(Kdrama,'fantasia')
;   Genero = 'fantasia', generoKdrama97(Kdrama,'fantasia')
